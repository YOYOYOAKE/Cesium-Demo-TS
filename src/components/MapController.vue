...
const handleDataUpload = (dataFile): void => {
...
const childRef = useTemplateRef('FileUploader')
...
<template>
  <el-drawer v-model="isDrawerOpen" title="Cesium Demo" direction="ltr">
    <!-- 底图管理 -->
    ...
    <div v-if="false">
      <el-select v-model="selectedShp" size="large" placeholder="加载或添加数据">
    ...
    <!-- <div>
      ...
      <el-button @click="callChildMethod">callChildMethod</el-button>
    </div> -->
  </el-drawer>
